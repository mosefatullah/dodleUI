...
var E = (t, o, e) => o in t ? x(t, o, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[o] = e;
...
const p = (t, o) => {
  ...
  if (e.options = S, typeof t == "string") {
    ...
    if (r)
      r.length == 1 ? e.elem = r[0] : e.elems = r;
    else
    ...
    o && typeof o == "object" && (e.options = Object.assign(e.options, o)), t instanceof HTMLElement ? e.elem = t : t instanceof NodeList ? e.elems = t : t instanceof Document ? e.elems = t.querySelectorAll("*") : e.options = Object.assign(e.options, t);
  else if (t == null)
    throw new Error("(Error: DoodleUI) Selector is empty! Provide a selector.");
  return e;
}, w = (t, o) => {
  t.elem ? o(t.elem) : t.elems && t.elems.forEach((e) => {
    o(e);
  });
}, S = {}, D = (t, o, e) => {
  let r = {};
  return typeof e == "object" && e.elem || e.elems ? r = e : r = p(t, o), (i, n) => {
    w(r, (s) => {
      ...
      new IntersectionObserver((d) => {
        d.forEach((c) => {
          c.isIntersecting ? typeof i == "function" && i(c) : c.isIntersecting || typeof n == "function" && n(c);
        });
      }).observe(s);
    });
  };
  ...
  let r = {};
  return typeof e == "object" && e.elem || e.elems ? r = e : r = p(t, o), (i) => {
    w(r, (n) => {
...
`);
    ...
    return "";
  return t;
}, f = (t) => t === "session" || t === "s" ? "session" : t === "cookie" || t === "c" ? "cookie" : t === "indexedDB" || t === "idb" || t === "db" || t === "database" ? "indexedDB" : "local", m = {
  setStorage(t, o, e, r = 365) {
    ...
    if (f(t) === "cookie") {
      ...
      n.onupgradeneeded = (function(s) {
        ...
        if (l.onerror = (d) => {
          ...
          let d = l.createObjectStore(
            e.table,
            typeof e.primary == "string" ? { keyPath: e.primary, autoIncrement: !0 } : { autoIncrement: !0 }
          );
          if (e.index && typeof e.index == "array")
            for (let c = 0; c < e.index.length; c++)
              typeof e.index[c][0] == "string" && typeof e.index[c][1] == "boolean" && d.createIndex(e.index[c][0], e.index[c][0], {
                unique: e.index[c][1]
              });
          else
            e.index && typeof e.index == "object" ? typeof e.index[0] == "string" && typeof e.index[1] == "boolean" && d.createIndex(e.index[0], e.index[0], {
              unique: e.index[1]
            }) : e.index && typeof e.index == "string" && d.createIndex(e.index, e.index, { unique: !0 });
        }
        ...
        if (e.table && typeof e.table == "string" && e.value) {
          ...
          d.objectStore(e.table).add(e.value).addEventListener("success", () => {
            i = {
      ...
      f(t) === "session" ? (e = b(e), sessionStorage.setItem(o, e)) : (e = b(e), localStorage.setItem(o, e));
    return i;
  },
  getStorage(t, o) {
    let e;
    if (f(t) === "cookie") {
      let r = o + "=", n = decodeURIComponent(document.cookie).split(";");
      ...
      r.onsuccess = function(i) {
        ...
        e = { error: "(Error: DoodleUI) Stoarge: " + i.target.error };
      };
    } else if (f(t) === "session") {
  ...
  removeStorage(t, o) {
    let e;
    return f(t) === "cookie" ? document.cookie = "" : f(t) === "indexedDB" ? ("indexedDB" in window || (e = {
      error: "(Error: DoodleUI) Storage: this browser doesn't support IndexedDB!"
    }), indexedDB.deleteDatabase(o)) : f(t) === "session" ? sessionStorage.removeItem(o) : localStorage.removeItem(o), e;
  },
  clearStorage(t) {
    let o;
    return f(t) === "cookie" ? document.cookie = "" : f(t) === "indexedDB" ? ("indexedDB" in window || (o = {
      error: "(Error: DoodleUI) Storage: this browser doesn't support IndexedDB!"
    }), indexedDB.databases().then((e) => {
      Array.isArray(e) && e.map((r) => {
        this.removeStorage(t, r.name);
      });
    })) : f(t) === "session" ? sessionStorage.clear() : localStorage.clear(), o;
  }
}, B = (t) => {
  let o, e = {
    Control: "Ctrl",
  ...
  document.onkeyup = function(r) {
    let i = r.key, n = r.ctrlKey, s = r.altKey, l = r.shiftKey;
    if (o = e[i] || i, o.length == 1 && (o = o.toUpperCase()), n && (o = "Ctrl+" + o), s && (o = "Alt+" + o), l && (o = "Shift+" + o), typeof t == "function")
      t(o, r);
    else
  ...
  let r = {};
  return typeof e == "object" && e.elem || e.elems ? r = e : r = p(t, o), () => {
    w(r, (i) => {
  ...
  constructor(o, e) {
    ...
    return this.elem = r, this.elems = i, this.options = n, this.init(), this instanceof g ? this : new g(o);
  }
  init() {
    this.options && this.options.class && (this.elem ? this.elem.classList.add(...this.options.class.split(" ")) : this.elems && this.elems.forEach((o) => {
